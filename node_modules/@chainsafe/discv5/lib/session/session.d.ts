...
export declare class Session {
     ...
     */
    static establishFromChallenge(localKey: IKeypair, localId: NodeId, remoteId: NodeId, challenge: IChallenge, idSignature: Uint8Array, ephPubkey: Uint8Array, enrRecord?: Uint8Array): [Session, ENR];
    /**
     * Encrypts a message and produces an handshake packet.
     */
    static encryptWithHeader(remoteContact: NodeContact, localKey: IKeypair, localNodeId: NodeId, updatedEnr: Uint8Array | null, challengeData: Uint8Array, message: Uint8Array): [IPacket, Session];
    /**
