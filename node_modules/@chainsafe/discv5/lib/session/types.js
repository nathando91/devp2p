...
(function (ResponseErrorType) {
    ...
    ResponseErrorType[ResponseErrorType["WrongAddress"] = 0] = "WrongAddress";
    /** The response type does not match the expected response type */
    ResponseErrorType[ResponseErrorType["WrongResponseType"] = 1] = "WrongResponseType";
    /** The response handler threw */
    ResponseErrorType[ResponseErrorType["InternalError"] = 2] = "InternalError";
