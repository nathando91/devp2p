...
export class Session {
    ...
    static establishFromChallenge(localKey, localId, remoteId, challenge, idSignature, ephPubkey, enrRecord) {
        ...
        if (!idVerify(createKeypair({ type: enr.keypairType, publicKey: enr.publicKey }), challenge.data, ephPubkey, localId, idSignature)) {
    ...
    static encryptWithHeader(remoteContact, localKey, localNodeId, updatedEnr, challengeData, message) {
        // generate session keys
        const [encryptionKey, decryptionKey, ephPubkey] = generateSessionKeys(localNodeId, getNodeId(remoteContact), getPublicKey(remoteContact), challengeData);
        const keys = { encryptionKey, decryptionKey };
