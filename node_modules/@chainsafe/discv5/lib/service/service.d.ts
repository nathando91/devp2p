...
import { ENR, NodeId, SignableENR } from "@chainsafe/enr";
import { BindAddrs, ITransportService } from "../transport/index.js";
...
import { Discv5EventEmitter, ENRInput, PongResponse, SignableENRInput } from "./types.js";
import { RateLimiterOpts } from "../rateLimit/index.js";
import { IDiscv5Metrics, MetricsRegister } from "../metrics.js";
/**
...
export declare class Discv5 extends Discv5_base {
     ...
     */
    sendFindNode(remote: ENR | Multiaddr, distances: number[]): Promise<ENR[]>;
    /**
     * Send TALKREQ message to dstId and returns response
     */
    sendTalkReq(remote: ENR | Multiaddr, payload: Uint8Array, protocol: string | Uint8Array): Promise<Uint8Array>;
    /**
     ...
     */
    sendPing(nodeAddr: ENR | Multiaddr): Promise<PongResponse>;
    /**
