...
import { INodesMessage, IPongMessage, ITalkReqMessage, ITalkRespMessage, RequestMessage } from "../message/index.js";
...
export declare function toResponseType(response: IPongMessage | INodesMessage | ITalkRespMessage): ResponseType;
